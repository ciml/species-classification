...
df_filtrado = df[df[coluna_classe].isin(contagens[contagens >= 100].index)]
...
# Primeiro: separar em treino (70%) e resto (30%)
train_df, temp_df = train_test_split(df_filtrado, test_size=0.30, stratify=df_filtrado[coluna_classe], random_state=42)

# Agora: dividir o resto em validação (15%) e teste (15%)
...
output_train_dir = 'D:/Users/anton/Desktop/imagens_particionadas/Batch1/train/'
output_val_dir = 'D:/Users/anton/Desktop/imagens_particionadas/Batch1/validation/'
output_test_dir = 'D:/Users/anton/Desktop/imagens_particionadas/Batch1/test/'
create_directories(output_train_dir, output_val_dir, output_test_dir)
